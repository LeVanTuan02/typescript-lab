...
const WebsiteLayout = (props: Props) => {
    return (
        <div>
            ...
            <footer>
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4  border-t pt-8">
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            <div className="flex">
                                ...
                                <a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"> 312 Lovely Street, NY </a>
                            </div>
                        </div>
                        <div>
